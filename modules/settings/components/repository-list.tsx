...
import { disconnectAllRepos, disconnectRepository, getConnectedRepositories } from "../actions"
                    ...
                    {repositories && repositories.length > 0 && (
                        <AlertDialog open={disconnectedAllOpen} onOpenChange={setdisconnectedAllOpen}>
                            ...
                            <AlertDialogContent>
                                ...
                                <AlertDialogFooter>
                                    <AlertDialogCancel className="hover:cursor-pointer hover:bg-red-700">Cancel</AlertDialogCancel>
                                    <AlertDialogAction onClick={() => disconnectAllMutation.mutate()}
                    ...
                    <div className="space-y-4">
                        {repositories.map((repo) => (
                            ...
                            >
                                ...
                                <AlertDialog>
                                    <AlertDialogTrigger asChild>
                                        <Button variant="ghost" size="sm" className="ml-4 text-destructive hover:text-destructive hover:bg-destructive/10 hover:cursor-pointer">
                                    ...
                                    <AlertDialogContent>
                                        <AlertDialogHeader>
                                            ...
                                            <AlertDialogDescription>
                                                This will disconnect <strong>{repo.fullName}</strong> and delete all associated AI reviews. This action cannot be undone.
                                            </AlertDialogDescription>
                                        </AlertDialogHeader>
                                        <AlertDialogFooter>
